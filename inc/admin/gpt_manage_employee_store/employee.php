        ...
        <div class="form-section">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="gpt-media-uploader">
                    ...
                    <button type="button" class="button gpt-select-image" data-target="#image_url">Chọn ảnh</button>
                ...
                <?php else: ?>
                    <button type="submit" name="add_employee" class="button button-primary">Thêm nhân viên</button>
                <?php endif; ?>
            </form>
        </div>
