...
function gpt_location_warnings_page() {
    ...
    <div class="wrap">
        ...
        <form method="get" class="search-form" style="margin: 20px 0;">
            <input type="hidden" name="page" value="gpt-canh-bao-vi-tri">
            
            <p class="search-box" style="display: inline-block; margin-right: 20px;">
                <label class="screen-reader-text" for="warning-search-input">Tìm kiếm cảnh báo:</label>
                <input type="search" id="warning-search-input" name="search" value="<?php echo esc_attr($search); ?>" placeholder="Tìm theo mã cào, tên, số điện thoại..." style="width: 300px;">
                <input type="submit" id="search-submit" class="button" value="Tìm kiếm">
            </p>
            
            <select name="status" onchange="this.form.submit();" style="margin-right: 10px;">
        ...
        <table class="wp-list-table widefat fixed striped">
            ...
            <tbody>
                ...
                <tr id="warning-<?php echo $warning->id; ?>" class="<?php echo $warning->status === 'pending' ? 'alternate' : ''; ?>">
                    ...
                    <td>
                        <button type="button" class="button button-small" onclick="toggleDetails(<?php echo $warning->id; ?>)">
                            Chi tiết
                        </button>
                    </td>
                </tr>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            ...
                            <div>
                                ...
                                <form method="post" style="margin-bottom: 10px;">
                                    ...
                                    <button type="submit" class="button">Cập nhật ghi chú</button>
                                </form>
                                
                                <form method="post" style="display: inline;">
                                    <input type="hidden" name="warning_id" value="<?php echo $warning->id; ?>">
                                    <input type="hidden" name="action" value="delete">
                                    <button type="submit" class="button button-link-delete" onclick="return confirm('Xác nhận xóa cảnh báo này?')" style="color: #dc3232;">
                                        Xóa cảnh báo
                                    </button>
                                </form>
                            </div>
        ...
        <div class="tablenav bottom">
            ...
            <div class="tablenav-pages">
                <span class="pagination-links">
                    <?php
                    $base_url = admin_url('admin.php?page=gpt-canh-bao-vi-tri');
